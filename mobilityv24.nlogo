...
to go
  ...
  if year mod 100 = 0 and evi-counter = 1 [ export-world (word "run_" run-counter "_eco_social_cc_" year ".csv") ]
...
to agent-commands
  ask camps
  [ move-decision
    if experiment-type = "null" or experiment-type = "social-only"
    [ if random 100 < 25
    ...
    discard
    demographics
    if experiment-type = "social-only" or experiment-type = "eco-social-climatechange"
    [ social ]
  ]
end
